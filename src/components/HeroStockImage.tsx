  ...
  return (
    <div className="relative flex flex-col items-center w-full">
      <div className="flex items-center justify-center">
        <img
          src={hero.img}
          alt="Hero finance visual"
          className="rounded-2xl shadow-xl object-cover max-h-60 sm:max-h-80 w-full sm:w-[640px] transition-all duration-500"
          style={{border: '4px solid #fff', background: "#f5faff"}}
        />
      </div>
    </div>
  );
