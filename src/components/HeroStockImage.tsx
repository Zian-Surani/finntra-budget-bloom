...
const HeroStockImage: React.FC<{activeIndex?: number}> = ({ activeIndex }) => {
  ...
  return (
    <div className="relative h-28 w-28 sm:h-36 sm:w-36 mx-auto flex items-center justify-center">
      <img
        src={LOGO_SRC}
        alt="FinnTra Logo"
        className="absolute left-0 top-0 h-full w-full opacity-40 blur-[1.5px] z-0 pointer-events-none rounded-full"
        draggable={false}
      ...
      <img
        ...
        className="h-24 w-24 sm:h-32 sm:w-32 rounded-full bg-white ring-4 ring-blue-200 dark:ring-blue-700 shadow-lg z-10 object-cover object-center"
